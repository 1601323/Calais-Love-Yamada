...
void CharaSelectScene::charaDraw()
{
	...
	Box = CCSprite::create("Player/PL_CharFlame01.png");
	Box->setScale(1.5f);
	Box->setPosition(165, 140);
	addChild(Box, 2);
	CCSprite *Box1 = CCSprite::create("Player/PL_CharFlame01.png");
	Box1->setScale(1.5f);
	Box1->setPosition(390, 140);
	addChild(Box1, 2);
	CCSprite *Box2 = CCSprite::create("Player/PL_CharFlame01.png");
	Box2->setScale(1.5f);
